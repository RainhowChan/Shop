			...
			<div class="hotProductCategory">
				<s:iterator var="c" value="categories">
					...
					<dl>
						...
						<s:iterator value="#c.categorySeconds" var="c">
							<dd>
								<a href="{pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="#c.csid"/>&page=1"><s:property value="#c.csname" /></a>
							</dd>
						</s:iterator>
					</dl>
				</s:iterator>
