	...
	<script type="text/javascript">
		$(document).ready(function(){
			$("#username").blur(function(){
				/* $.get("${pageContext.request.contextPath}/user_checkUserName.action?username="+$(this).val()+"&"+new Date().getTime(),function(data,status){
					//alert("Data: " + data + "\nStatus: " + status);
					if(status=="success"){
						$("#username_tip").html(data);
					}
				}); */
				$("#username_tip").load("${pageContext.request.contextPath}/user_checkUserName.action?cacheCode="+new Date().getTime(),{'username':$(this).val()});
			});
			
			$("#captchaImage").click(function(){
				this.src="${pageContext.request.contextPath}/checkImgCode.action?cacheCode="+new Date().getTime();
			});
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" method="post" novalidate="novalidate" action="${pageContext.request.contextPath }/user_regist" onsubmit="return checkForm();">
						<table>
							<tbody>
								<tr>
									<th><span class="requiredField">*</span>用户名:</th>
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20"/><span><s:fielderror fieldName="username"/></span><span id="username_tip"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off"/><span><s:fielderror fieldName="password"/></span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <label> <input
												type="radio" name="sex" value="0" checked="checked"/>男
								...
								<tr>
									...
									<input type="text"
											id="checkcode" name="code" class="text captcha"
											maxlength="4" autocomplete="off"/>
											<img id="captchaImage" class="captchaImage"
												src="${pageContext.request.contextPath}/checkImgCode.action"
												title="点击更换验证码""/>
												</span><span><s:actionerror/></span></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
