			...
			<div class="wrap">
				<div class="main">
					<div class="title">
						...
						<h3 style="color:#000; display:inline-block;"><s:actionerror /></h3>
					</div>
					<form id="loginForm"  method="post" action="${pageContext.request.contextPath }/user_login.action" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
										用户名/E-mail:
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="code" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImgCode.action" title="点击更换验证码"">
											<s:actionerror />
										</span>
									</td>
								</tr>
